...
<?php } elseif($action == "edit") { ?>
													<div class="col-lg-12">
														<div class="card-box">
															<h4 class="m-t-0 header-title"><b><?=$page_name;?></b></h4>
															<p class="text-muted m-b-30 font-13">
										* Zorunlu alanlar - Yazıyı siyah yapmak için --><b> <?php echo htmlspecialchars("<font color=\"#000000\"> YAZI BURAYA GELİCEK </font>", ENT_QUOTES); ?> </b><-- Bu şekilde yazınız.<br>(#000000 Hex Renk kodudur, istediğiniz gibi değiştirebilirsiniz.)
									</p>
									<?php
										if($verot_alert == 2) { alert_error("Yüklenirken bir hata oluştu (HATA 1)"); }
										elseif($verot_alert == 3) { alert_error("Yüklenirken bir hata oluştu (HATA 1)"); }
