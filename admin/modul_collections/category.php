		...
		if(in_array($row["type"], $normal_kayit)) {
			...
			if($_POST["search"] == "") {
				...
				echo '<td style="width:20px"><i class="glyphicon glyphicon-sort"></i></td>';
													...
													<td><a href="<?=$link;?>subpage=items&cat_id=<?=$rows->id;?>" class="btn btn-info waves-effect waves-light"> <i class="fa fa-folder-open-o m-r-5"></i> <span>İncele</span> </a></td>
