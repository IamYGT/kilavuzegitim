									...
									<div class="bar-widget">
										<div class="table-box">
                                            ...
                                            <div class="table-detail text-right">
                                                <span data-plugin="peity-pie" data-colors="#34d3eb,#ebeff2" data-width="50" data-height="45"><?=$c_tekil;?>/<?=$c_cogul;?></span>
                                            </div>
								...
								<div class="card-box">
									<div class="bar-widget">
										<div class="table-box">
                                            ...
                                            <div class="table-detail text-right">
                                                <span data-plugin="peity-donut" data-colors="#34d3eb,#ebeff2" data-width="50" data-height="45"><?=$b_tekil;?>/<?=$b_cogul;?></span>
                                            </div>
