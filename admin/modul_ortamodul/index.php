...
$tablo = array(
	...
	array(
		"name" => "İkon https://fontawesome.com/v4.7.0/icons/ ",
		"url" => "icon",
		"type" => "text",
		"options" => "",
		"forced" => 1,
...
if($rows["type"] == "text") { echo '<div class="form-group"><label class="col-md-2 control-label">' . $rows["name"] . '</label><div class="col-md-7"><input ' . $zorunlu . ' type="text" name="' . $rows["url"] . '" class="form-control" value="' . stripslashes($db->VeriOkuTek($vt, $rows["url"], "id", $id)) . '"></div></div>'; }
elseif($rows["type"] == "hidden") {  }
elseif($rows["type"] == "textarea") { echo '<div class="form-group"><label class="col-md-2 control-label">' . $rows["name"] . '</label><div class="col-md-7"><textarea ' . $zorunlu . ' name="' . $rows["url"] . '" class="form-control" rows="5">' . stripslashes($db->VeriOkuTek($vt, $rows["url"], "id", $id)) . '</textarea></div></div>'; }
