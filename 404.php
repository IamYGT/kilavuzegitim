...
<head>
    ...
    <title>- Kılavuz l Kişisel Gelişim Kursu</title>
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-nav-wrapper pull-right">
                    <ul class="nav navbar-nav navbar-right" id="responsive-menu">
                        ...
                        <li>
                            <div class="get-quote">
                                <a href="#" class="mt_btn_white-bor">Apply Now</a>
                            </div>
                        </li>
                    </ul>            
                </div><!--/.nav-collapse -->
    ...
    <section id="error" class="">
        <div class="container">
            <div class="notfound text-center">
                ...
                <p class="mar-top-20">The page you are looking for might have been removed had its name changed or is temporarily unavailable.</p>
                <a href="index.html" class="mt_btn_yellow mar-top-20">Home Page</a>
            </div>
        </div>
    </section>
    <!--* End error Section*=-->
